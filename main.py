...
def run_models_on_dataset(archive, ds_name, in_size, out_size, batch_size, tcn_epochs, gru_epochs,
    ...
    # Run GRU model
    x_test, y_test, yhat_test = run_gru_model(train_dl, test_dl, out_size=out_size, batch_size=batch_size,
                                              epochs=gru_epochs)
